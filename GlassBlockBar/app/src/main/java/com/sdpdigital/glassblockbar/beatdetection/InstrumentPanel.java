...
package com.sdpdigital.glassblockbar.beatdetection;
			   ...
			   GestureDetector.OnDoubleTapListener
{
    ...
    public void setOnFftResultListener(SpectrumGauge.OnFFTResultListener listener) {
        audioAnalyser.setOnFftResultListener(listener);
    }

    public int getNyquestFreq() {
        if (spectrumGauge == null) {
            return 0;
        }
        return spectrumGauge.getNyquistFreq();
    }
